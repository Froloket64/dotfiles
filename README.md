...
## DEPRECATION NOTICE
This is a **deprecated** branch. It contains configs that won't be maintained in the future, unless I decide otherwise at some point.
They will be removed from other branches.

To get to safety, switch to another branch, such as `gruvbox`.
